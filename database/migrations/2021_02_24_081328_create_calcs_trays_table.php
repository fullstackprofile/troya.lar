...
class CreateCalcsTraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calcs_trays', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedTinyInteger('tray_type_filter')->default(0);
            $table->unsignedFloat('tray_width')->default(0);
            $table->unsignedFloat('tray_height')->default(0);
            $table->unsignedFloat('tray_radius')->default(0);
    ...
    {
        Schema::dropIfExists('calcs_trays');
    }
}
